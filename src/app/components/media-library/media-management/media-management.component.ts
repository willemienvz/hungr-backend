...
@Component({
  ...
  template: `
    ...
    <mat-dialog-actions align="end">
      <button class="hungr-btn hungr-btn-secondary" mat-dialog-close>Cancel</button>
      <button class="hungr-btn hungr-btn-primary" [mat-dialog-close]="{ category }">Categorize</button>
    </mat-dialog-actions>
  `
})
...
@Component({
  ...
  template: `
    ...
    <mat-dialog-actions align="end">
      <button class="hungr-btn hungr-btn-secondary" mat-dialog-close>Cancel</button>
      <button class="hungr-btn hungr-btn-primary" [mat-dialog-close]="true">Proceed</button>
    </mat-dialog-actions>
  `
})
